...
function Package(props) {
	...
	useEffect(function () {
		...
		invoke("update_title", { title: "Package builder" });
				...
				<div className="form-area">
					...
					<fieldset disabled={internalWorking}>
						...
						<div className="field-wrapper">
							...
							<input type="radio" className="field-input" onChange={props.onInputChange} id="package-i" value="i" name="package" checked={state.package === "i"}></input>
						</div>
						<div className="field-wrapper">
							<label className="field-label" htmlFor="package-p">Portfolio:</label>
							<input type="radio" className="field-input" onChange={props.onInputChange} id="package-p" value="p" name="package" checked={state.package === "p"}></input>
						</div>
					</fieldset>
				</div>
